<?php
$USER_ID = "u19132";
$DIR = "/../system/units/$USER_ID/plugins/";
...
$root_path = $_SERVER['DOCUMENT_ROOT'] . $DIR;
...
html{overflow-y:scroll}body{padding:0;font:22px/26px Tahoma,Arial,sans-serif;color:#e83b6e;background:#2a6478}
input,select,textarea,button{font-size:inherit;font-family:inherit}
a{color:#f07d14;text-decoration:none}a:hover{color:#b00}img{vertical-align:middle;border:none}
...
.path{padding:4px 7px;border:1px solid #f07d14;background-color:#fff;margin-bottom:10px}
...
.filename{color:#f07d14;max-width:420px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.break-word{word-wrap:break-word}
input { border: none; background: #e83b6e; color: #fff; cursor: pointer;  }
</style>
...
<p class="center"><small><a href="/" style="color: #f07d14;">В ПАНЕЛЬ</a></small></p>
</div>
<script>
